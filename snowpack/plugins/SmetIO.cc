...
std::string SmetIO::getFieldsHeader(const SnowStation& Xdata) const
{
	...
	if (out_canopy)
	{
		...
		os << "Shortwave_radiation_up_above_canopy Shortwave_radiation_down_above_canopy Longwave_radiation_up_below_canopy Longwave_radiation_down_below_canopy Shortwave_radiation_up_below_canopy Shortwave_radiation_down_below_canopy Total_land_surface_albedo" << " "; //7
...
void SmetIO::writeTimeSeriesData(const SnowStation& Xdata, const SurfaceFluxes& Sdata, const CurrentMeteo& Mdata, const ProcessDat& Hdata, const double &wind_trans24, smet::SMETWriter& smet_writer) const
{
    ...
    data.push_back(  Xdata.Cdata.rlwrbc );                // upward longwave radiation BELOW canopy
    data.push_back(  Xdata.Cdata.ilwrbc );                // upward longwave radiation BELOW canopy
    data.push_back(  Xdata.Cdata.rswrbc );                // upward longwave radiation BELOW canopy
    data.push_back(  Xdata.Cdata.iswrbc );                // upward longwave radiation BELOW canopy
